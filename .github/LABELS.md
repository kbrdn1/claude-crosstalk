...
| `build`        | `#BFD4F2` | Makefile, plugin manifests |

## Domain labels (crosstalk-specific)

| Name           | Color     | Description |
|:---------------|:----------|:------------|
| `pane`         | `#7057FF` | `/crosstalk` pane: layout, picker, reply field |
| `hooks`        | `#5319E7` | `session.receive`, `tool.call`, command and render hooks |
| `thread`       | `#0E8A16` | conversation state (`hooks/thread.ts`) |
| `types`        | `#0075CA` | pinned plugin API declarations (`types/`) |
| `install`      | `#006B75` | Makefile, marketplace, settings flag |
| `security`     | `#B60205` | Security issues / leaks of peer messages |
